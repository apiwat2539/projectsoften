...
/* @var $searchModel app\models\modelsearch\TeacherSearch */
  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="/projectsoften/web/teacher/index">อาจารย์</a></li>
    ...
    <p>
        <?= Html::a('เพิ่มอาจารย์', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
